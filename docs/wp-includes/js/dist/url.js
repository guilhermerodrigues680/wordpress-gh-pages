 ...
 * const authority2 = getAuthority( 'https://guilhermerodrigues680.github.io/wordpress-gh-pages:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://guilhermerodrigues680.github.io/wordpress-gh-pages:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://guilhermerodrigues680.github.io/wordpress-gh-pages:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://guilhermerodrigues680.github.io/wordpress-gh-pages:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://guilhermerodrigues680.github.io/wordpress-gh-pages:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
